...
function relative_time(date){var relative_to=(arguments.length>1)?arguments[1]:new Date();var delta=parseInt((relative_to.getTime()-date)/1000,10);var r='';if(delta<1){r='justo ahora';}else if(delta<60){r=delta+' segungos';}else if(delta<120){r='Hace un minuto apróx.';}else if(delta<(45*60)){r='hace '+(parseInt(delta/60,10)).toString()+' minutos apróx';}else if(delta<(2*60*60)){r='hace 1 hora apróx.';}else if(delta<(24*60*60)){r='hace '+(parseInt(delta/3600,10)).toString()+' horas';}else if(delta<(48*60*60)){r='hace 1 día';}else{r='hace '+(parseInt(delta/86400,10)).toString()+' días';}
return r;}
