...
//                echo "Host: ".  $this->host."<br>";
        ...
        // coloca 2 para activar el Debug
     ...
     * @param string $attacht   archivo adjunto
     * @param string $email_alternativo correo alternativo
     * @return string  
     */
    public function enviar_email($asunto,$mensaje, $textoAlternativo, $emailDestinatario, $nombreDestinatario ="",$attach=null,$email_alternativo="",$imagen=null) {
        ...
        if ($imagen != null) {
            foreach ($imagen as $value) {
                $this->mail->AddEmbeddedImage($value['path'], $value['cid'], $value['name'], "base64", $value['type']);
            }
        }
        ...
        if (!$email_alternativo=="") {
            $this->mail->AddCC($email_alternativo,$nombreDestinatario);
        }
