...
Class Misc {
    ...
    public static function error_handler($num, $err, $file, $line) {
        ...
        $headers .= 'From: Pronet21 Daemon <noreply@pronet21.com.ve>' . "\r\n";
        $html = "";
...
//                $email = new mailto(SMTP);
//                $email->enviar_email(EMAIL_TITULO, $html, '', EMAIL_CONTACTO);
...
//            echo "<code style='border:1px solid black; background-color:white!important; border-radius:5px;'>" . $html . "</code>";
            ...
            mail("ynfantes@gmail.com", "pronet21.com.ve: Error", $html, $headers);
        }
        // </editor-fold>
    }
